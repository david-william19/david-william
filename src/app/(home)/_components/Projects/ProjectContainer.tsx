  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="border border-white rounded-full w-fit py-[13px] px-[24px] flex">
            <Image
              ...
              className="mr-2.5"
            />
            <h3 className="font-sans text-sm">MOBILE</h3>
          </span>
          <h2 className="uppercase font-thunder font-extrabold text-[80px]">
            {project.name}
          </h2>
          <p className="font-sans text-[16px]">{project.description}</p>
        </motion.div>
        <motion.div
          variants={CardVariants}
          key="2"
        ...
        <motion.div variants={CardVariants} key="3" className="self-end flex-1">
