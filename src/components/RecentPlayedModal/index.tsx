...
import RecentPlayedContent from "../RecentPlayedContent";

export default function RecentPlayedModal() {
        ...
        <div>
         <Popover>
          ...
          >
            ...
            <PopoverContent className="bg-[#232935] border-none bg-opacity-75">
             <RecentPlayedContent />
            </PopoverContent>
          </Popover>
        </div>
